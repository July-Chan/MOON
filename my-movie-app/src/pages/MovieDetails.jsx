      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <img 
            ...
            alt={movie.title} 
            style={{ 
              width: isMobile ? '200px' : '300px', // Менший постер на мобілці
              borderRadius: '20px', 
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ 
            ...
            <div style={infoItemStyle}>
              ...
              <span style={{ fontSize: '16px', fontWeight: 'bold' }}>{movie.vote_average?.toFixed(1)}</span>
            </div>
            
            <div style={infoItemStyle}>
              <Calendar size={18} color="#a0a0b5" />
              <span style={{ fontSize: '16px' }}>{new Date(movie.release_date).getFullYear()}</span>
            </div>
            ...
            <div style={infoItemStyle}>
              ...
              <span style={{ fontSize: '16px' }}>{movie.genres?.[0]?.name}</span> 
            </div>
          </div>
          ...
          <div style={{ 
            ...
            <p style={{ margin: '5px 0' }}><strong style={{ color: '#8a3ffc' }}>Країна:</strong> {movie.production_countries?.map(c => c.name).slice(0, 2).join(', ')}</p>
